    ...
    <div className="font-sans">
      ...
      <nav 
        ...
        className={`fixed w-full top-0 z-[110] transition-all duration-500 bg-transparent py-5 ${
          scrolled ? 'bg-[#FAFAF9]/90 backdrop-blur-xl border-b border-stone-200/50 py-3' : ''
        }`}
      >
      ...
      {/* ================= 4. STATS ================= */}
      <section id="stats-section" className="pt-0 pb-32 md:pb-40 bg-white relative z-50 border-t border-stone-100 overflow-visible">
