  ...
  return (
    <div key={messageId}>
      <header className="mb-6">
        <button
          onClick={() => router.back()}
          className="w-10 h-10 rounded-full glass-card flex items-center justify-center text-stone-600 hover:bg-white/80 transition-colors mb-4"
        >
        ...
        <div>
          ...
          <p className="text-stone-500 font-light text-sm">
            Adaptează mesajul pentru copilul tău.
          </p>
        </div>
      </header>
